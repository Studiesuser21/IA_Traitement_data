...
df_authlog =pd.read_csv('/home/xibalpa/authlog.csv',header=None,error_bad_lines=False)
...
df=pd.concat([df_syslog,df_kernlog1,df_dmesg,df_kernlog1, df_debug,df_auth,df_casperlog,df_kern,df_squidcachelog,df_squidcachelog1,df_sysloginstaller], ignore_index=True) #df_kernlog1, df_debugdf_auth,df_casperlog,df_kern,df_squidcachelog,df_squidcachelog1,df_dmesg 
...
with open('/home/xibalpa/Documents/elasticsearch/dataframe_multilogunpc.csv') as f:
    reader = csv.DictReader(f)
    helpers.bulk(es, reader, index='testdixvingtsept')'''
