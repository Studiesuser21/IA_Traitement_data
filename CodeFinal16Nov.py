...
df['ssh']=(df['message_log'].str.contains('ssh'))*1
df['nmap']=df['message_log'].str.contains('nmap')*1
df['ftp']=df['message_log'].str.contains('ftp')*1
df['http']=df['message_log'].str.contains('HTTP')*1
df['Nikto']=df['message_log'].str.contains('Nikto')*1
